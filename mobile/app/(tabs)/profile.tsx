...
import { ArrowLeft, FileText, Download, Eye, ShieldCheck, ShieldAlert, Phone, Info, HelpCircle, Award } from 'lucide-react-native';
        ...
        <View className="bg-white rounded-3xl p-5 mb-6 shadow-sm border border-slate-100">
          ...
          <View className="flex-row justify-between mb-5">
             <View className="bg-slate-50 items-center justify-center flex-1 rounded-2xl py-4 mr-2">
                ...
                <Text className="text-slate-500 text-[10px] uppercase tracking-wider text-center">Total Trips</Text>
             </View>
             ...
             <View className="bg-slate-50 items-center justify-center flex-1 rounded-2xl py-4 mx-1">
                ...
                <Text className="text-slate-500 text-[10px] uppercase tracking-wider text-center">High-Risk Zones</Text>
             </View>
             ...
             <View className="bg-slate-50 items-center justify-center flex-1 rounded-2xl py-4 ml-2">
                ...
                <Text className="text-slate-500 text-[10px] uppercase tracking-wider text-center">Safety Score</Text>
             </View>
          </View>
